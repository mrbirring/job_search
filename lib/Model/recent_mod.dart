...
//
//     final recentData = recentDataFromJson(jsonString);

// import 'dart:convert';

// RecentData recentDataFromJson(String str) =>
//     RecentData.fromJson(json.decode(str));
...
//         jobPublisher: publisherValues.map[json["job_publisher"]]!,
//         jobEmploymentType:
//             employmentTypeValues.map[json["job_employment_type"]]!,
...
//         jobRequiredSkills: json["job_required_skills"] == null
//             ? []
//             : List<String>.from(json["job_required_skills"]!.map((x) => x)),
...
//         jobPostingLanguage:
//             jobPostingLanguageValues.map[json["job_posting_language"]]!,
...
//         "job_publisher": publisherValues.reverse[jobPublisher],
//         "job_employment_type": employmentTypeValues.reverse[jobEmploymentType],
//         "job_title": jobTitle,
...
//         "job_required_skills": jobRequiredSkills == null
//             ? []
//             : List<dynamic>.from(jobRequiredSkills!.map((x) => x)),
...
//             jobPostingLanguageValues.reverse[jobPostingLanguage],
...
// enum Publisher { LINKED_IN, OLX, SIMPLY_HIRED }

// final publisherValues = EnumValues({
//   "LinkedIn": Publisher.LINKED_IN,
//   "OLX": Publisher.OLX,
//   "SimplyHired": Publisher.SIMPLY_HIRED
// });

// enum JobCity { DERA_BASSI, SAHIBZADA_AJIT_SINGH_NAGAR }

// final jobCityValues = EnumValues({
//   "Dera Bassi": JobCity.DERA_BASSI,
//   "Sahibzada Ajit Singh Nagar": JobCity.SAHIBZADA_AJIT_SINGH_NAGAR
// });

// enum JobCountry { IN }

// final jobCountryValues = EnumValues({"IN": JobCountry.IN});

// enum EmploymentType { FULLTIME }

// final employmentTypeValues = EnumValues({"FULLTIME": EmploymentType.FULLTIME});
...
// enum JobPostingLanguage { EN }

// final jobPostingLanguageValues = EnumValues({"en": JobPostingLanguage.EN});
...
// final jobStateValues = EnumValues({"PB": JobState.PB});
...
//                 .map((x) => employmentTypeValues.map[x]!)),
...
//             ? []
//             : List<dynamic>.from(
//                 employmentTypes!.map((x) => employmentTypeValues.reverse[x])),
