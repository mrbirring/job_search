...
class Datum {
  ...
  List<dynamic>? estimatedSalaries;
  List<ApplyOption>? applyOptions;
  List<dynamic>? employerReviews;
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        estimatedSalaries: json["estimated_salaries"] == null
            ? []
            : List<dynamic>.from(json["estimated_salaries"]!.map((x) => x)),
        applyOptions: json["apply_options"] == null
            ? []
            : List<ApplyOption>.from(
                json["apply_options"]!.map((x) => ApplyOption.fromJson(x))),
        employerReviews: json["employer_reviews"] == null
            ? []
            : List<dynamic>.from(json["employer_reviews"]!.map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "estimated_salaries": estimatedSalaries == null
            ? []
            : List<dynamic>.from(estimatedSalaries!.map((x) => x)),
        "apply_options": applyOptions == null
            ? []
            : List<dynamic>.from(applyOptions!.map((x) => x.toJson())),
        "employer_reviews": employerReviews == null
            ? []
            : List<dynamic>.from(employerReviews!.map((x) => x)),
      };
}
...
class Parameters {
  String? jobId;
  bool? extendedPublisherDetails;

  Parameters({
    this.jobId,
    this.extendedPublisherDetails,
  });

  factory Parameters.fromJson(Map<String, dynamic> json) => Parameters(
        jobId: json["job_id"],
        extendedPublisherDetails: json["extended_publisher_details"],
      );
