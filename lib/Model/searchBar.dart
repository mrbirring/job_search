...
//
//     final  searchcont =  searchcontFromJson(jsonString);

import 'dart:convert';

searchcont searchcontFromJson(String str) =>
    searchcont.fromJson(json.decode(str));

String searchcontToJson(searchcont data) => json.encode(data.toJson());
...
class searchcont {
  ...
  factory searchcont.fromJson(Map<String, dynamic> json) => searchcont(
        status: json["status"],
